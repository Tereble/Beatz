        ...
        <nav class="navbar navbar-expand gap-3">
            ...
            <div class="user-box dropdown px-3">
                <a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ asset('storage/' . $settings->logo) }}" class="user-img" alt="user avatar">
                    <div class="user-info">
                        <p class="user-name mb-0">{{ $settings->app_name }}</p>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a href="{{ route('admin.logout') }}" class="dropdown-item d-flex align-items-center" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
