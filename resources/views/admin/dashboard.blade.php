              ...
              <div class="card radius-10 w-100">
                <div class="card-body">
                  ...
                  <div class="hstack flex-wrap align-items-center justify-content-between gap-3 gap-sm-4 mb-3 border p-3 radius-10">
                    <div class="">
                        <h5 class="mb-0">974 <span class="text-white font-13">56% <i class='bx bx-up-arrow-alt'></i></span></h5>
                        <p class="mb-0">Page Views</p>
                    </div>
                    <div class="vr"></div>
                    <div class="">
                        <h5 class="mb-0">1,218 <span class="text-white font-13">34% <i class='bx bx-down-arrow-alt'></i></span></h5>
                        <p class="mb-0">Total Sales</p>
                    </div>
                    <div class="vr"></div>
                    <div class="">
                        <h5 class="mb-0">42.8% <span class="text-white font-13">22% <i class='bx bx-up-arrow-alt'></i></span></h5>
                    ...
                    <div class="product-list p-3 mb-3">
                        ...
                        <div class="d-flex flex-column gap-3">
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/14.png') }}" width="50" alt="" />
                                </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/19.png') }}" width="50" alt="" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/04.png') }}" width="50" alt="" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/18.png') }}" width="50" alt="" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/10.png') }}" width="50" alt="" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/08.png') }}" width="50" alt="" />
                                </div>
                                <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-3 p-2 border radius-10">
                                <div class="">
                                    <img src="{{ asset('assets/images/products/03.png') }}" width="50" alt="" />
                                </div>
                                <div class="flex-grow-1">
                    ...
                    <div class="card-body">
                         <div class="social-leads">
                            <div class="d-flex align-items-center gap-3">
                                <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-facebook-circle' ></i></div>
                                <div class="flex-grow-1">
                            ...
                            <hr>
                            <div class="d-flex align-items-center gap-3">
                                <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-google' ></i></div>
                                <div class="flex-grow-1">
                            ...
                            <hr>
                            <div class="d-flex align-items-center gap-3">
                                <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-twitter'></i></div>
                                <div class="flex-grow-1">
                            ...
                            <hr>
                            <div class="d-flex align-items-center gap-3">
                                <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-linkedin' ></i></div>
                                <div class="flex-grow-1">
                            ...
                            <hr>
                            <div class="d-flex align-items-center gap-3">
                                <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-dribbble' ></i></div>
                                <div class="flex-grow-1">
                            ...
                            <hr>
                            <div class="d-flex align-items-center gap-3">
                                <div class="widgets-icons-small text-white bg-light"><i class='bx bxl-behance' ></i></div>
                                <div class="flex-grow-1">
